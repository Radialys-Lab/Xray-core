...
На деле этот холивар решился в пользу того, что 3x-UI включили Https в запрос. Https там уже был, но настраивался по желанию юзеров. Архитектура у панели была корретная.
